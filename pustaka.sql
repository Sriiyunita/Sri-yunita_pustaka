...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Okt 2021 pada 06.42
...
(17, 'form hobby to money', 4, 'Deasylawati ', 'elex media komputindo', 2015, '87968686787879', 5, 0, 0, 'img1557403658.jpg'),
(18, 'buku saku pramuka ', 8, 'rudi himawan', 'pusat perbukuan ', 2016, '97868687978796', 6, 0, 0, 'img1557404613.jpg'),
(19, 'rahsia keajaiban bumi', 3, 'nurul ihsan ', 'luxima', 2014, '565756565768868', 5, 0, 0, 'img1557404689.jpg');
...
CREATE TABLE `user` (
  ...
  `paswood` varchar(256) CHARACTER SET latin1 NOT NULL,
